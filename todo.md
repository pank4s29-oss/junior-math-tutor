...
- [ ] 診斷並修復正式環境 Gemini 解題服務對清楚照片與檔案一律失敗的問題
- [ ] 補齊檔案／照片模型失敗可追溯診斷與成功解題回歸驗證，並同步修復版本
...
- [ ] 以受控測試帳號在正式 Vercel 網站端對端驗證照片／PDF／文字題目匯入、教材歸屬單元、錯題標記與二次練習
...
- [ ] 驗證多題工作階段、教師上限與同檔案追問後同步 GitHub 與正式部署
