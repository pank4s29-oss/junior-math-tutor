...
export type AIChatBoxProps = {
  ...
  /** 提供時，空狀態會顯示一顆前往「練習題生成」區塊的按鈕；沒有題目的學生不必自己想題目。 */
  onGoToPracticeGenerator?: () => void;
};
...
export function AIChatBox({
  ...
  emptyStateMessage = "從一題你正在思考的數學題開始", suggestedPrompts, batchMaxQuestions = 5, onGoToPracticeGenerator,
}: AIChatBoxProps) {
